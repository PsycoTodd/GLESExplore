...
#ifndef GLESEXPLORE_TEAPORT_H
#define GLESEXPLORE_TEAPORT_H
...
private:
    ...
    std::vector<float> TEAPOT_VERTS = { 11.222200, 0.110300, 20.030291, 10.302300,
    ...
    std::vector<float> TEAPOT_TEX_COORDS = { 0.608828, 0.354913, 0.609037, 0.414650,
    ...
    std::vector<float> TEAPOT_NORMS = { -0.964496, 0.067011, -0.255454, -0.865037,
    ...
    std::vector<unsigned int> TEAPOT_INDICES = { 0, 1, 2, 2, 3, 0, 4, 5, 6, 6, 7, 4, 8, 9,
